    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                intent.putExtra(DetailMovieActivity.EXTRA_TITLE, item.getMovie_title());
                intent.putExtra(DetailMovieActivity.EXTRA_OVERVIEW, item.getMovie_description());
                intent.putExtra(DetailMovieActivity.EXTRA_RELEASE_DATE, item.getMovie_date());
                intent.putExtra(DetailMovieActivity.EXTRA_POSTER, item.getMovie_image());
                intent.putExtra(DetailMovieActivity.EXTRA_RATE_COUNT, item.getMovie_rate_count());
                intent.putExtra(DetailMovieActivity.EXTRA_RATE, item.getMovie_rate());
